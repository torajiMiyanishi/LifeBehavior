...
//        TSOARSBuilder builder = new TSOARSBuilder(simulationStart, simulationEnd, tick, stages, agentTypes, spotTypes);
        TSOARSBuilder builder = createBuilder(simulationStart, simulationEnd, tick, stages, seed); //SOARSビルダ
        // *************************************************************************************************************
...
//        builder.setRandomSeed(seed);
        ...
        // gisデータ類のパス
        String dirToInput = "C:\\Users\\tora2\\IdeaProjects\\LifeBehavior\\BasicLifeBehaviorAddTrip\\";
        ...
        List<TSpot> homes = spotManager.createSpots(SpotType.Home, noOfHomes); // 自宅スポットを生成．(Home1, Home2, ...)
        ...
        List<TSpot> workPlaces = spotManager.createSpots(SpotType.WorkPlace, noOfWorkPlaces); //活動場所スポットの生成
...
//            spotLogPW.println();
    ...
    private static TSOARSBuilder createBuilder(String startTime, String endTime,
                                               String tick, List<Enum<?>> stages, long seed) throws IOException {
        ...
        TSOARSBuilder builder = new TSOARSBuilder(startTime, endTime, tick, stages, agentTypes, spotTypes); // ビルダー作成
